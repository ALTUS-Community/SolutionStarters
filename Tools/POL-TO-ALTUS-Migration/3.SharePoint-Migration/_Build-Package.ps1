...
- **1-export-lists.ps1** - SharePoint export script
- **2-import-lists.ps1** - Dynamics 365 import script

### Helper Libraries
- **CommonFunctions.ps1** - Consolidated utilities (logging, project mapping, CMT conversion, field handlers)
